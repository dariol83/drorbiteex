...
/**
 * Name generator implementation for CCSDS OEM files.
 */
public interface IOemNameGenerator {
    /**
     ...
     */
    String generateFileName(OemGenerationRequest request, Date generationDate);
}
